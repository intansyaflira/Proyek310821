    ...
    if($_POST){
        ...
        if(empty($nama_produk)){
            ...
            include "cekkoneksi.php";
                ...
                $update=mysqli_query($conn,"update produk set nama_produk='".$nama_produk."', deskripsi='".$deskripsi."', harga='".$harga."' ,foto_produk='".$foto_produk."' WHERE nama_produk='".$nama_produk."'") or die(mysqli_error($conn));
                ...
                if($update){
                    ...
                    echo "<script>alert('Gagal update produk');location.href='ubahproduk.php?nama_produk=".$nama_produk."';</script>";
